...
let constr = solve(),
    sc = new constr.ShoppingCart();
    let p1 = new constr.Product('shit1','shitty',1),
        p2 = new constr.Product('bshit2','shitty2',2),
        p3 = new constr.Product('bshit2','shittu',4);
    sc.add(p1).add(p2).add(p3);
